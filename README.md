...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0c5786bd5526223e356079577ded77fa921447c5/C/CUTEst/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/ralna/CUTEst.git (revision: `9fe696355fa50bfa7add79fce8a402d06dd40310`)
